...
document.addEventListener("DOMContentLoaded", () => {
  ...
  {
      "question": "Mikä on planeetta, joka tunnetaan myös 'punaisena planeettana'?",
...
},
{
    ...
    "options": ["Josef Stalin", "Leonid Brežnev", "Vladimir Lenin", "Mihail Gorbatšov"],
    "answer": "Vladimir Lenin"
},
{
    "question": "Mikä on Afrikan suurin järvi?",
    "options": ["Victoriajärvi", "Tanganjikajärvi", "Malawijärvi", "Chad-järvi"],
...
{
    "question": "Mikä oli ensimmäinen planeetta, joka löydettiin teleskoopilla?",
...
},
{
    ...
    "options": ["Amazonin sademetsä", "Kongon sademetsä", "Taiga", "Sundarbans"],
...
},
{
  ...
  "options": ["Niagaran putoukset", "Iguazún putoukset", "Angel-putous", "Victoria-putoukset"],
  "answer": "Angel-putous"
},
{
...
},
{
  ...
  "options": ["Sally Ride", "Valentina Tereškova", "Mae Jemison", "Yuri Gagarin"],
...
{
  "question": "Missä kaupungissa järjestettiin ensimmäiset modernit olympialaiset vuonna 1896?",
...
{
  "question": "Kuka oli Englannin kuningatar, joka hallitsi vuodesta 1952 vuoteen 2022?",
  "options": ["Kuningatar Viktoria", "Kuningatar Elisabet I", "Kuningatar Elisabet II", "Kuningatar Anne"],
  "answer": "Kuningatar Elisabet II"
},
{
  "question": "Mikä merkitsee auringonpimennystä?",
  "options": ["Kuu kulkee Auringon ohi", "Maa peittää Auringon", "Venus peittää Auringon", "Saturnuksen renkaat peittävät Auringon"],
...
},
{
  ...
  "options": ["Rooman valtakunta", "Egyptiläiset", "Mesopotamia", "Kreikkalaiset"],
  "answer": "Mesopotamia"
},
{
  "question": "Mikä on korkein vuori Pohjois-Amerikassa?",
  "options": ["Mount Whitney", "Mount McKinley (Denali)", "Mount Logan", "Mount Elbert"],
...
{
  "question": "Mikä vuosi oli ensimmäinen modernien olympialaisten järjestämisvuosi?",
...
},
{
  ...
  "options": ["Atlantin keskiselänne", "Mariaanien hauta", "Karibianmeri", "Filippiinien hauta"],
  "answer": "Mariaanien hauta"
},
{
  "question": "Kuka oli antiikin Kreikan viisauden ja sodankäynnin jumalatar?",
...
{
  "question": "Mikä oli ensimmäinen mantere, joka löydettiin tutkimusmatkojen aikana?",
...
},
{
  ...
  "options": ["Amazonin sademetsä", "Taiga", "Kongon sademetsä", "Sundarbans"],
  "answer": "Taiga"
},
{
...
{
  "question": "Missä maassa järjestettiin maailman ensimmäinen jalkapallon MM-kilpailu?",
